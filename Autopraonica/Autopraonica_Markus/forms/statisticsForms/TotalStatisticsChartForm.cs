...
{
    public partial class TotalStatisticsChartForm : Form
    {
        public TotalStatisticsChartForm(DateTime dt1, DateTime dt2)
        {
            InitializeComponent();
            fillChart(dt1, dt2);
        }
        ...
        private void fillChart(DateTime dt1, DateTime dt2)
        {
            ...
            label2.Text = "Troskovi za period " + dt1.ToString("dd/MM/yyyy") + " - " + dt2.ToString("dd/MM/yyyy") + " iznose: " + costs;
        }
    }
}
